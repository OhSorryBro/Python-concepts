...
# 7.9. No Pastrami
# Use sandwich_orders from 7.8, make sure pastrami appears at least three times. At the start of the program print that the bar has run out of pastrami, then use a while loop to remove all occurrences of 
